...
describe('xml-reader', () => {
    describe('DataSources', () => {
        ...
        it('should throw an error if datasource node contains text nodes', (done) => {
            xmlReader(__dirname + '/fixtures/xml-reader/invalid-datasource-text-node.xml')
                .catch((err) => {
                    expect(err).to.be.instanceof(Error);
        ...
        it('should throw an if xml contains invalid text nodes', (done) => {
            xmlReader(__dirname + '/fixtures/xml-reader/invalid-text-node.xml')
                .catch((err) => {
                    try {
                        expect(err).to.be.instanceof(Error);
    ...
    it('should generate an error if XML cannot be parsed', (done) => {
        xmlReader(__dirname + '/fixtures/xml-reader/broken.xml')
            .catch((err) => {
                expect(err).to.be.instanceof(Error);
                done();
            });
