...
module.exports = function resultBuilder(api, request, rawResults, resolvedConfig) {
    ...
    context = {
        ...
        primaryRawResult: null, // current primary rawResult
    ...
    context.primaryRawResult = rawResult;
...
function buildItem(parentAttrNode, row, context) {
    ...
    if (context.primaryKey === null) {
        ...
        var indexKey = resAttrNode.resolvedPrimaryKey ?
            resAttrNode.resolvedPrimaryKey[resAttrNode.primaryDataSource] : context.primaryRawResult.childKey;
        ...
        if (attrNode.attributes) {
            ...
            if (attrNode.dataSources) {
                ...
                if (!subRow) {
                    ...
                    subContext.primaryRawResult = rawResult;
