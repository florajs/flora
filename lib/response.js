...
Response.prototype.send = function (payload) {
    ...
    if (this.cursor && this.cursor.totalCount && this.request.page && this.request.limit) {
        this.cursor.totalPages = Math.ceil(this.cursor.totalCount / this.request.limit);
        this.cursor.page = parseInt(this.request.page, 10);
        this.cursor.limit = parseInt(this.request.limit, 10);
    }
