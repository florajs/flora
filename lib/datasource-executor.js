    ...
    return (new Promise(function (resolve) {
        ...
        .then(function executeMainRequest() {
            ...
            return new Promise(function (resolve, reject) {
                ...
                dst.request._profiler = dst._profiler.child(dst.attributePath.join('.') + ':' + dst.dataSourceName + '#dataSourceRequest');
        ...
        .then(function executeSubRequests(mainResults) {
            ...
            var subRequests = dst.subRequests.map(function (subRequest) {
                ...
                subRequest._profiler = dst._profiler.child(subRequest.attributePath.join('.') + ':' + subRequest.dataSourceName);
