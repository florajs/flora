...
async function executeDst(api, request, dst) {
    ...
    callExtension('preExecute', dst.dataSourceName, preExecuteEvent, dst.extensions);
    ...
    callExtension('postExecute', dst.dataSourceName, postExecuteEvent, dst.extensions);
