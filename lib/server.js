...
class Server {
    ...
    run(callback) {
        ...
        this.api.init(config, (err) => {
            ...
            return this._httpServer.listen(config.port, () => {
    ...
    _handleRequest(httpRequest, httpResponse) {
        this.api.emit('httpRequest', { httpRequest, httpResponse }, (extErr) => {
            if (extErr) return this._sendError(extErr, httpRequest, httpResponse);
            ...
            return httpToFloraRequest(httpRequest)
                .then((floraRequest) => {
                    if (!floraRequest) {
