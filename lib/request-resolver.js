                ...
                if (subResourceAttrNodes.length > 0) {
                    ...
                    if (subFilter.rewriteTo) {
                        ...
                        subResourceAttrNodes.forEach((subResourceAttrNode) => {
                            ...
                            resolvedFilter.valueFromSubFilter = filterContext.resourceTree.subFilters.length;
...
function resolveResourceTree(resourceTree, parentDataSourceName) {
    ...
    if (resourceTree.filterSourceAttribute) dataSourceTree.filterSourceAttribute = resourceTree.filterSourceAttribute;
